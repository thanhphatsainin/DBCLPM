 ...
 * @author DELL
 */
public class EditPointStudent extends HttpServlet {
...
//            point.setId(ID);
            ...
            point.setCC(Float.parseFloat(cc));
            point.setTP1(Float.parseFloat(tp1));
            point.setTP2(Float.parseFloat(tp2));
            point.setDT(Float.parseFloat(dt));
            
            pointDAO.editPoint(point, ID);
