                ...
                <div class="products-slide">
                    ...
                    <div class="item" >
                        <div class="evo-product-block-item"> 
                            <div class="box-image"> 
                                <a href="/view/client/sanphamdon.jsp" class="evo-image-pro product-item-photo" title="">
                                    <img src="/static/admin/images/${product.image}" class="img-fluid">
                                </a> 
                                <div class="label_product"> 
                                    <span class="label_sale"> ${product.priceInit}*100/${product.price} </span> 
                                </div> 
                            </div> 
                ...
                <div class="section_blogs_item_around">
                    <div class="section_blogs_item">
                        <div class="item-news-index" > 
                            <div class="item-news-image"> 
                                <a href=""> 
                                    <img src="/static/admin/images/blog1.jpg" class="img-fluid"> 
                                </a>
                            </div> 
                            <div class="item-news-content"> 
                                <h4> 
                                    <a href="" tabindex="-1">6 items thời trang nhẵn mặt trong tủ đồ Hè của phụ nữ Pháp vì cứ mặc là đẹp và sang xịn mãi không thôi</a> 
                                </h4> 
                                <div class="zone-content"> Style của phụ nữ Pháp chứa đựng cả một kho kiến thức mặc đẹp. Và chỉ đơn giản là thuộc mặt những items thân quen tro... 
                                </div> 
                            </div> 
                        </div>
                    </div>
                    <div class="section_blogs_item">
                        <div class="item-news-index" > 
                            <div class="item-news-image">
                                <a href="" tabindex="-1"> 
                                    <img src="/static/admin/images/blog2.jpg" class="img-fluid">
                                </a> 
                            </div>
                            <div class="item-news-content">
                                <h4> 
                                    <a href="">6 kiểu tóc "hot hit" đi đâu cũng gặp nhờ công của Jennie: Tập tành diện theo thì bạn xinh xẻo, trendy hơn là cái chắc</a> 
                                </h4>
                                <div class="zone-content"> Nàng nào sành mốt ắt cũng rõ ràng trend diện băng đô kì thực đã làm hội chị em "dậy sóng" suốt một thời gian và còn ...
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="section_blogs_item">
                        <div class="item-news-index">
                            <div class="item-news-image">
                                <a href=""> 
                                    <img src="/static/admin/images/blog3.jpg" class="img-fluid">
                                </a>
                            </div>
                            <div class="item-news-content"> 
                                <h4> 
                                    <a href="">12 set đồ đời thường của sao Hàn rõ là đơn giản nhưng vẫn xịn đẹp và hút mắt hết sức
                                    </a> 
                                </h4> <div class="zone-content"> Nhìn chung, style đời thường của các sao nữ xứ Hàn không hề cầu kỳ, làm quá; họ thường lên đồ với những items cơ bản... 
                                </div> 
                            </div> 
                        </div>
                    </div>
                    <div class="section_blogs_item">
                        <div class="item-news-index"> 
                            <div class="item-news-image"> 
                                <a href=""> 
                                    <img src="/static/admin/images/blog4.jpg" class="img-fluid">
                                </a> 
                            </div> 
                            <div class="item-news-content">
                                <h4> 
