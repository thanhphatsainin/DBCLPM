				...
				<div class="row">
					...
					<h1 class="logo col-md-2 col-sm-2 col-xs-6 col-xs-push-3 col-sm-push-0">
						...
						<a href="index.html" title="Mua Yến Sào">
							<img src="/static/admin/images/footer-logo.png" class="img-responsive center-block" width="160" height="auto">
						</a>
					</h1>
					<div class="col-xs-12 col-sm-6 col-md-6">
						<div class="menu">
							<nav class="menu-primary visible-lg visible-md">
								<ul>
									<li class="main-menu-item current-menu-item current_page_item menu-item-home"><a href="/view/client/trangchu.jsp" class="">Trang chủ</a></li>
									...
									<li class="main-menu-item menu-item-has-children"><a href="/view/client/lienhe.jsp">Liên hệ</a></li>
								</ul>
							</nav>						
						</div>
					</div>
